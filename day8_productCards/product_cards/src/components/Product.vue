    ...
    <div class="product">
        <div :class="'product-inner ' + product.color">
            ...
            <div class="product-detail">
                <h2> {{product.title}} </h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta modi iusto sint! Sed natus fuga, sequi pariatur at nisi modi!</p>
            </div>
        </div>
    </div>
</template>
...
<style>
    ...
    .product-inner.blue {
        background-image: linear-gradient(to bottom right, #24D484, #2474C4 70%);
    }
